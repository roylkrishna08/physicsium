...
import { Users, FlaskConical, Activity, ShieldCheck, BookOpen } from 'lucide-vue-next';
...
const stats = computed(() => [
  ...
  { name: 'Total Units', value: adminStore.units.length, icon: BookOpen, color: '#ffaa00' },
]);
  ...
  <div class="dashboard-home animate-fade-in">
    ...
    <div class="recent-activity glass-card">
      ...
      <div class="activity-list">
        ...
        <div v-else v-for="user in recentUsers" :key="user._id" class="activity-item">
