        ...
        <div class="auth-container">
            <div class="auth-card">
                ...
                <div class="auth-header">
                    ...
                    <p>Create your account and unlock the universe of physics</p>
                </div>
                ...
                <div class="auth-footer">
                    <router-link to="/login-form" class="link-primary">
...
.auth-card {
    ...
    box-shadow: 0 20px 60px rgba(0, 0, 0, 0.4), 0 0 100px rgba(129, 140, 248, 0.1);
    overflow: hidden;
}
...
.card-border {
    ...
    border-radius: 32px;
    padding: 1px;
    background: linear-gradient(135deg, rgba(129, 140, 248, 0.5), rgba(99, 102, 241, 0.5), rgba(168, 85, 247, 0.5));
...
.input-glow {
    position: absolute;
    inset: -2px;
    background: linear-gradient(135deg, rgba(129, 140, 248, 0.3), rgba(99, 102, 241, 0.3));
    border-radius: 14px;
    opacity: 0;
